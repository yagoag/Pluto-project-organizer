...
<div id="chart-container">
	<!-- ToDo -->
	<div id="todo">
		<div class="title"><?php echo "<a href=\"chart_do?project=\"" . $project . "&act=add_todo\">"; ?><input type="button" class="new-item" /></a> To Do</div>
		<ul>
	...
	<!-- Doing -->
	<div id="doing">
		<div class="title"><?php echo "<a href=\"chart_do?project=\"" . $project . "&act=add_doing\">"; ?><input type="button" class="new-item" /></a> Doing</div>
		<ul>
	...
	<!-- Done -->
	<div id="done">
		<div class="title"><?php echo "<a href=\"chart_do?project=\"" . $project . "&act=add_done\">"; ?><input type="button" class="new-item" /></a> Done</div>
		<ul>
